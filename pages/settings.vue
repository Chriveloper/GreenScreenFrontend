  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
      ...
      <div class="flex justify-between items-center pt-6 border-t">
        <div class="text-sm text-gray-500">Changes are saved automatically when you click Save buttons above.</div>
        <button @click="resetAllLimits"
                class="text-red-600 hover:text-red-700 text-sm font-medium transition">Reset All Limits
        </button>
      </div>
    </div>
  </div>
