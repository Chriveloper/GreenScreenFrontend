<template>
  <div class="container mx-auto px-4 py-8">
    <h1 class="text-2xl font-bold text-green-600 mb-6">Focus Session</h1>
    ...
    <div class="bg-white rounded-lg shadow-lg p-8 max-w-md mx-auto">
      ...
      <div class="mb-6">
        ...
        <input type="text" id="goal" placeholder="What will you focus on?" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
      </div>
